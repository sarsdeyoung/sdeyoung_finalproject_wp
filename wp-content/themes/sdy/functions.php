...
{ 
	...
	wp_enqueue_style('Droid Serif', 'http://fonts.googleapis.com/css?family=Droid+Serif', false, false, false );
	wp_enqueue_style('Quicksand', 'http://fonts.googleapis.com/css?family=Quicksand', false, false, false );
	wp_enqueue_style('Questrial', 'http://fonts.googleapis.com/css?family=Questrial', false, false, false );
}
